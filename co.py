...
#<---------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    def open_lo_window(self):
            ...
            def download_template_lab():
                ...
                lab_template_generator(basic_values_lo, receiver_email.get())
           ...
           # Row 4: Title Label for the merged column area
            ...
            for i in range(1, 18):
                ...
                if i==1 or i==10 :
                    ...
                    exp_lo_labels[f"exp{i-1}_lo_label"].grid(row=0, column=0, padx=5, pady=0, sticky="nsw")
                    if i<10:
                        exp_lo_entry[f"exp{i-1}_lo_entry"] = ctk.CTkEntry(inner_frame, placeholder_text="1,2,3,4,5,6", font=("Arial", 15), width=150)
                        exp_lo_entry[f"exp{i-1}_lo_entry"].grid(row=0, column=1, padx=(5, 5), pady=0, sticky="nsew")
                        ...
                        exp_lo_entry[f"exp{i-2}_lo_entry"].grid(row=0, column=1, padx=(5, 5), pady=0, sticky="nsew")
            ...
            # Download button
            receiver_email = create_entry_box(" LO Mapping ", " Enter the Email ID ", "Arial", 15, 200, row=right_row, column=4, sticky="w", padx=10)
            ...
            button_upload_lab = create_button(" Upload Excel File (Lab) ", "Upload", "Arial", 20, 200, 40, upload_lab_file, row=2, column=2,colspan=2, sticky="", padx=10)
